...
'Be':{'Z':4, 'L':2,'Zv':2, 'Rv':1.53,'Rc':0.90,'m':9.01,  'V':15.00,'En':1.81,'alapha':5.60, 'IP':9.323, 'EA':0.0},
...
'Ca':{'Z':20,'L':4,'Zv':2, 'Rv':1.97,'Rc':1.74,'m':40.08, 'V':32.02,'En':0.95,'alapha':22.8, 'IP':6.113, 'EA':0.018},
...
'Rb':{'Z':37,'L':5,'Zv':1, 'Rv':2.44,'Rc':2.11,'m':85.47, 'V':60.85,'En':0.31,'alapha':47.3, 'IP':4.177, 'EA':0.486},
'Sr':{'Z':38,'L':5,'Zv':2, 'Rv':2.49,'Rc':1.92,'m':87.62, 'V':64.67,'En':0.72,'alapha':27.6, 'IP':5.695, 'EA':0.110},
'Mo':{'Z':42,'L':5,'Zv':6, 'Rv':2.00,'Rc':1.45,'m':95.94, 'V':33.51,'En':1.15,'alapha':12.80,'IP':7.092, 'EA':0.746},
'Ru':{'Z':44,'L':5,'Zv':8, 'Rv':1.35,'Rc':1.46,'m':101.07,'V':10.31,'En':1.60,'alapha':9.00, 'IP':7.36,  'EA':1.01},
